// This is part of Vencord, a modification for Discord's desktop app.
// This file is licensed under the GNU General Public License v3.0.
// Below you will find the original licence notice, as well as the accompanying source code.
...
export default class Logger {
    ...
    private _log(level: "log" | "error" | "warn" | "info" | "debug", levelColor: string, args: any[], customFmt = "") {
        console[level](
            `%c Nyaa++ %c %c ${this.name} ${customFmt}`,
